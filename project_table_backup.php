...
<table class="table table-striped responsive-utilities jambo_table bulk_action" id="datatable">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title text-center">Incident</th>
                        <th class="column-title text-center">PM</th>
                         <th class="column-title text-center">Product</th>
                        <th class="column-title text-center">Contact</th> 
                        <th class="column-title text-center">Sale</th> 
                    ...
                    <!--   end status       -->
                    <!--    service Type       -->
                        <td class="text-center" style="vertical-align:middle"><? echo $row_project['service_type_1'].'<br/>'.$row_project['service_type_2'] ?></td>
                    <!--    End service Type       -->   
                    <!--    Incident / PM       -->
                     <td class="text-center" style="vertical-align:middle"><? echo $row_project['incident'] ?></td>

                      <td class="text-center" style="vertical-align:middle"><? echo $row_project['pm'] ?></td>
                    ...
                    <!--   End Product      -->
                     ...
                     <!--    Contact      -->
                     <td class="text-center" style="vertical-align:middle"><? echo $row_project['cus_name'].'<br/>'.$row_project['cus_email'].'<br/>'.$row_project['cus_tel'] ?></td>
                    <!--   End Contact      -->
                    <!--    Sale     -->
                     <td class="text-center" style="vertical-align:middle"><? echo $row_project['sale'] ?></td>
                    <!--   End Sale     -->
                    <!--   Action   -->
                       <td   style="vertical-align:middle">
                         ...
                         <? if($row_project['remark']!='complete'){ ?>
                          <button  class="btn btn-danger btn-xs btn_delete" data-title="<? echo $row_project['project_id']."|".$row_project['customer_name']."|".$row_project['start_date'] ?>"><i class="fa fa-trash-o"></i> Delete </button>
                          <? } ?>
                        </td>
                     <!-- End  Action   -->
