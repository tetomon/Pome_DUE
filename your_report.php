 ...
 <script type="text/javascript">
          $(document).ready(function() {
                                      ...
                                      jQuery.ajax({
                                       ...
                                       url: "count_status_your.php", //Where to make Ajax calls
                                       dataType:"text",
    ...
    $(document).ajaxComplete(function(){
        $("#LoadingImage").css("display", "none");
             ...
             $( "#result" ).load("your_report_table.php", function(responseTxt, statusTxt, xhr) {
      ...
      e.preventDefault();
                ...
                var num_complete = num_info[3];
                 ...
                 document.getElementById('div_complete').innerHTML = '<h1><i class="fa fa-check blue"></i>Complete:  <font color="#5DADE2">'+num_complete+'</font></h1>'; 
        ...
        <div class="">
            ...
            <div class="title_left">
              <h3>
               <input type="hidden" id="count_status" name="count_status" value="">
                    Your Report (<font color="blue"><? echo $_SESSION['first_name'].' '.$_SESSION['last_name'] ?></font>)
          ...
          <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
             <div class="x_panel">
              <div class="x_title">
                <h2>Number Complete Report <small></small></h2>
              ...
              <div class="x_content">
                ...
                <div class="bs-example" data-example-id="simple-jumbotron">
                  <div class="jumbotron" id='div_complete'>
